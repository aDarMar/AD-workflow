function CDstall = CDstall_fun(a,cd_mean,a_w,CLw_s,TR,AR,eps_ae,Cl_a)
...
for n=1:5
    ...
    cdfit = polyval(p,a); %cd del profilo 2d ottenuto con il polinomio 
...
CDstall = cdfit+ CDi; %non c'è contributo di wave perchè siamo a basso mach
end